...
schema_write_file = types.FunctionDeclaration(
    name="write_file",
    description="""Writes the provided content to the provided file_path.
            If no file exists at the provided file_path. It will be created. Constrained to the working directory""",
